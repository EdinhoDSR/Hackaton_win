...
import os
import csv
from edinho import importance
from tika import parser
path = r"CV\Resume&Job_Description\Original_Resumes"
...
def scanCV(dirs) :
    for file in dirs :
        if "pdf" in file :     
            raw = parser.from_file(r"CV\Resume&Job_Description\Original_Resumes\\"+file)
            #print(raw['content'])
            #print("\n\n")
...
#print(wordsCount)
updateKeyWords()
print(importance(keyWords,r"CV\Resume&Job_Description\Original_Resumes\1Amy.pdf"))
#print(keyWords)
